...
final class CoordinatorPointCloud: MTKCoordinator {
    ...
    var confSelection: Int
    var scaleMovement: Float
    ...
    init(arData: ARProvider, confSelection: Int, scaleMovement: Float) {
        self.arData = arData
        self.currentCameraMode = .sidewaysMovement
        self.confSelection = confSelection
        self.scaleMovement = scaleMovement
    ...
    func calcCurrentPMVMatrix(viewSize: CGSize) -> matrix_float4x4 {
        ...
        return projection * orientationOrig
    }
